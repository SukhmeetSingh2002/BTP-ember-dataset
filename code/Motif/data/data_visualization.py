...
def plotLossCurve(history,save = True):
  ...
  # val_loss = history.history['val_loss']k
...
def plotAll(y_test, y_pred, y_pred_binary,history, labels,title):
  # plotROC(y_test, y_pred,save)
  plot_confusion_matrix(y_test, y_pred_binary,title,labels = labels)
